...
class threadsLoginModule:
    ...
    def login(self):
        ...
        loginElement = WebDriverWait(driver, 60).until(EC.presence_of_element_located((By.XPATH, "/html/body/div[2]/div/div/header/div[3]/a")))
        loginElement.click()
        loginElement = WebDriverWait(driver, 60).until(EC.presence_of_element_located((By.XPATH, "/html/body/div[2]/div/div/div[2]/div/div/div/div[2]/div[1]/div[3]/form/div/div[1]/input")))
        loginElement.send_keys(settings["account"])
        loginElement = WebDriverWait(driver, 60).until(EC.presence_of_element_located((By.XPATH, "/html/body/div[2]/div/div/div[2]/div/div/div/div[2]/div[1]/div[3]/form/div/div[2]/input")))
        ...
        for i in elementPath:
            if i != "postingSettingsClick":
                ...
                WebDriverWait(driver, 60).until(EC.presence_of_element_located((By.XPATH, "/html/body/div[4]/div[1]/div/div[2]/div/div/div/div[2]/div/div/div/div[2]/div/div[2]/div/div[3]/div")))
        ...
        postingElement = WebDriverWait(driver, 60).until(lambda d: d.find_element(By.XPATH,"/html/body/div[4]/div[1]/div/div[2]/div/div/div/div[2]/div/div/div/div[2]/div/div[1]/div/div/div[3]/div[1]/div[1]"))
        postingElement.send_keys(settings["postingMessage"])
        time.sleep(3)
        postingElement = WebDriverWait(driver, 60).until(lambda d: d.find_element(By.XPATH,"/html/body/div[4]/div[1]/div/div[2]/div/div/div/div[2]/div/div/div/div[2]/div/div[2]/div/div[1]/div"))
        postingElement.click()
